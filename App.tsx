            ...
            <div className="flex flex-wrap gap-3 mt-6 md:mt-0">
              {CATEGORIES.map((cat) => (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold transition-all duration-300 ${activeCategory === cat.name
