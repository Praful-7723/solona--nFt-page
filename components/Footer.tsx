        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="space-y-6">
                    <div className="flex items-center">
                         <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-purple-600 to-blue-600 flex items-center justify-center mr-2 shadow-[0_0_15px_rgba(168,85,247,0.5)]">
                            <span className="font-display font-bold text-md">A</span>
                        </div>
                        <span className="font-display font-bold text-xl tracking-wider">AcZone</span>
                    </div>
            ...
            <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p className="text-gray-500 text-xs">
                    © 2024 AcZone NFT Market. All rights reserved.
                </p>
